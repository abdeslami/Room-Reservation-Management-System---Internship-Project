    ...
    <body>
        ...
        <section class = "bg-nero min-h-[640px] mx-auto px-3 flex items-center py-16">
            <div class="container max-w-[1200px] mx-auto grid md:grid-cols-2 gap-14">
                <div class = "flex flex-col justify-center items-start">
                    ...
                    <h1 class = "font-gilda text-2xl sm:text-[38px] tracking-[.04em] font-normal py-3 text-white mb-3">Andermatt Resort & Ferme</h1>
                    <p class = "opacity-60 font-light font-barlow text-justify text-base sm:text-lg text-white">Andermatt est situé au milieu des Alpes suisses. Ces dernières années, Andermatt Swiss Alps a développé ses infrastructures, créé des opportunités attractives pour les investisseurs et créé de nouveaux emplois pour l'ensemble de la région.</p>
                ...
                <div class = "welcome-slider overflow-hidden">
                    <div class = "h-[425px]">
                        <img class = "w-full h-full object-cover" src ={{asset("assets/images/welcome-img-1.png")}}  alt = "welcome image">
                    </div>
                    <div class = "h-[425px]">
                        <img class = "w-full h-full object-cover" src = {{asset("assets/images/welcome-img-2.png")}} alt = "welcome image">
                    </div>
                    <div class = "h-[425px]">
                        <img class = "w-full h-full object-cover" src = {{asset("assets/images/welcome-img-3.png" )}} alt = "welcome image">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class = "py-16 px-3">
            <div id="CHAMBRE" class="container max-w-[1200px] mx-auto">
                ...
                <div class="flex items-center justify-center">
                    <img src = "assets/images/decorated-pattern-2.svg" {{asset("logo.png")}} alt = "">
                </div>
                <div class = "grid gap-10 md:grid-cols-2 py-10">
                    <p class = "text-black opacity-60 font-light text-base sm:text-lg font-barlow first-letter:text-4xl first-letter:font-bold first-letter:tracking-[.03em]">Andermatt est situé au milieu des Alpes suisses. Ces dernières années, Andermatt Swiss Alps a développé ses infrastructures, créé des opportunités attractives pour les investisseurs et créé de nouveaux emplois pour l'ensemble de la région.</p>

                    <ul class = "bg-lion py-5 sm:py-9 px-7">
                        <li class = "grid items-center grid-cols-[32px_auto] my-1">
                            <img src =  {{asset("assets/images/icons/hotel.svg")}} alt = "">
                ...
                <div class = "grid sm:grid-cols-2 lg:grid-cols-3 gap-[4px]">
                    <a href = "#" class = "object-cover relative after:absolute after:content-[''] after:top-0 after:left-0 after:w-full after:h-full after:bg-gradient-to-b from-black/25 to-black/75 hover:before  before:absolute before:content-[''] before:top-3 before:left-3 before:right-3 before:bottom-3 before:border-white before:border-2 before:border-solid before:z-10 before:opacity-0 hover:before:opacity-100 before:transition before:duration-300 before:ease-in-out">
                        <img src =  {{asset("assets/images/room-1.png")}} class = "w-full h-full object-cover" alt = "">
                    ...
                    <a href = "#" class = "object-cover relative after:absolute after:content-[''] after:top-0 after:left-0 after:w-full after:h-full after:bg-gradient-to-b from-black/25 to-black/75 hover:before  before:absolute before:content-[''] before:top-3 before:left-3 before:right-3 before:bottom-3 before:border-white before:border-2 before:border-solid before:z-10 before:opacity-0 hover:before:opacity-100 before:transition before:duration-300 before:ease-in-out">
                        <img src =  {{asset("assets/images/room-2.png")}} class = "w-full h-full object-cover" alt = "">
                    ...
                    <a href = "#" class = "object-cover relative after:absolute after:content-[''] after:top-0 after:left-0 after:w-full after:h-full after:bg-gradient-to-b from-black/25 to-black/75 hover:before  before:absolute before:content-[''] before:top-3 before:left-3 before:right-3 before:bottom-3 before:border-white before:border-2 before:border-solid before:z-10 before:opacity-0 hover:before:opacity-100 before:transition before:duration-300 before:ease-in-out">
                        <img src =  {{asset("assets/images/room-3.png")}} class = "w-full h-full object-cover" alt = "">
        ...
        <section class = "py-16 px-3 bg-booking-image bg-center bg-cover bg-no-repeat">
            <div id="CONTACT" class = "container max-w-[1200px] mx-auto">
                ...
                <form class = "my-16 max-w-[824px] mx-auto">
                    ...
                    <div class="flex items-center justify-center">
                        <a  href = "#" class = "bg-white font-barlow px-4 min-w-[158px] min-h-[48px] inline-flex items-center justify-center uppercase text-eerie-black transition duration-300 ease-in-out hover:bg-eerie-black hover:text-white mt-8 tracking-widest">EXPLORER MAINTENANT</a>
                    </div>
                </form>
            </div>
        </section>
